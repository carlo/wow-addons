...
local MINOR_VERSION = tonumber(string.sub("$Revision: 51880 $", 12, -3))
...
--		["Judgement of Reckoning"] = true,
		...
		--["Remote Toy"] = true,
		["Remove Curse"] = "Eliminar Maldición", -- before 2.2 "Deshacer maldici\195\179n"
		["Remove Insignia"] = "Quitar insignia",   -- check
		["Remove Lesser Curse"] = "Eliminar Maldición Menor", -- before 2.2 "Deshacer maldici\195\179n inferior",
		["Rend"] = "Desgarrar",
		["Renew"] = "Renovar",
