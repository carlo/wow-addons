...
if (GetLocale() == "deDE") then
    ...
    -- Zone names
    FLIGHTMAP_MOONGLADE     = "Mondlichtung";
    ...
    FLIGHTMAP_HILLSBRAD     = "Vorgebirge des H\195\188gellands";
    ...
    FLIGHTMAP_ASHENVALE     = "Eschental";
    FLIGHTMAP_1KNEEDLES     = "Tausend Nadeln";
    FLIGHTMAP_DESOLACE      = "Desolace";
    FLIGHTMAP_DUSTWALLOW    = "D\195\188stermarschen";
    FLIGHTMAP_FERALAS       = "Feralas";
    FLIGHTMAP_TANARIS       = "Tanaris";
    FLIGHTMAP_AZSHARA       = "Azshara";
    FLIGHTMAP_FELWOOD       = "Teufelswald";
    FLIGHTMAP_UNGOROCRATER  = "Krater von Un'Goro";
    FLIGHTMAP_SILITHUS      = "Silithus";
    FLIGHTMAP_WINTERSPRING  = "Winterquell";
    FLIGHTMAP_TELDRASSIL    = "Teldrassil";
    FLIGHTMAP_DEADWINDPASS  = "Gebirgspass der Totenwinde";
    FLIGHTMAP_ORGRIMMAR     = "Orgrimmar";
    FLIGHTMAP_THUNDERBLUFF  = "Donnerfels";
    FLIGHTMAP_UNDERCITY     = "Unterstadt";
    FLIGHTMAP_IRONFORGE     = "Eisenschmiede";
    FLIGHTMAP_STORMWIND     = "Sturmwind"
    FLIGHTMAP_DARNASSUS     = "Darnassus";

    -- Burning Crusade zones
    FLIGHTMAP_BLADESEDGE    = "Schergrat";
    FLIGHTMAP_HELLFIRE      = "H\195\182llenfeuerhalbinsel";
    FLIGHTMAP_NAGRAND       = "Nagrand";
    FLIGHTMAP_NETHERSTORM   = "Nethersturm";
    FLIGHTMAP_SHADOWMOON    = "Schattenmondtal";
    FLIGHTMAP_SHATTRATH     = "Shattrath";
    FLIGHTMAP_TEROKKAR      = "W\195\164lder von Terokkar";
    FLIGHTMAP_ZANGARMARSH   = "Zangarmarschen";

    FLIGHTMAP_EXODAR        = "Die Exodar";
    FLIGHTMAP_SMOON         = "Silbermond";
    FLIGHTMAP_AZUREMYST     = "Azurmythosinsel";
    FLIGHTMAP_BLOODMYST     = "Blutmythosinsel";
    FLIGHTMAP_GHOSTLANDS    = "Geisterlande";
    FLIGHTMAP_EVERSONG      = "Immersangwald";
