...
-- create prat module
Prat_ChatLink = Prat:NewModule(PRAT_MODULE)
Prat_ChatLink.revision = tonumber(string.sub("$Revision: 53296 $", 12, -3))
...
Prat_ChatLink.Categories = { cat.LINK, cat.TEXT, cat.FILTER, cat.BEHAVIOR }
