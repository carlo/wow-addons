...
-- create prat module
Prat_ChannelReordering = Prat:NewModule(PRAT_MODULE)
Prat_ChannelReordering.revision = tonumber(string.sub("$Revision: 51543 $", 12, -3))
...
Prat_ChannelReordering.Categories = { cat.CHANNEL, cat.BEHAVIOR }
