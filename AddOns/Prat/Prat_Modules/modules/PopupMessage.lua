...
L:RegisterTranslations("esES", function() return {
    ...
    ["An alternate name to show in popups."] = "Un nombre alternativo para mostrar en las ventanas emergentes",
...
-- create prat module
Prat_PopupMessage = Prat:NewModule(PRAT_MODULE, "Sink-1.0")
Prat_PopupMessage.revision = tonumber(string.sub("$Revision: 51543 $", 12, -3))
...
Prat_PopupMessage.Categories	= { cat.INFO, cat.DEV, cat.FRAME, cat.BEHAVIOR }	-- eg { cat.TEXT, cat.INFO }
...
--    self.moduleOptions.args.usemsbt.hidden = function() if MikSBT then return false else return true end end
	...
	self:RegisterEvent("Prat_PostAddMessage")
