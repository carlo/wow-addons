...
Prat_CopyChat = Prat:NewModule(PRAT_MODULE)

Prat_CopyChat.revision = tonumber(string.sub("$Revision: 53282 $", 12, -3))
    ...
    self.moduleOptions = {
        ...
        args = {
	        ...
	        copyformat = {
	            ...
	            validate = { ["plain"] = L["Plain"], ["html"] = L["HTML"], ["bbcode"] = L["BBCode"] },
			    usage =  L["Plain"] .. "|" .. L["HTML"] .. "|" .. L["BBCode"],
	        },
...
function Prat_CopyChat:UnitPopup_ShowMenu(dropdownMenu, which, unit, name, userData, ...)
    local ORIGIN_FRAME = SELECTED_CHAT_FRAME
...
function Prat_CopyChat:CopyLineFromPlayerlink(origin_frame, ...)
    local frame = origin_frame or SELECTED_CHAT_FRAME
