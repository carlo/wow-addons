...
Prat_Sounds.revision = tonumber(string.sub("$Revision: 51543 $", 12, -3))
...
Prat_Sounds.Categories	= { cat.FILTER, cat.SOUNDS }	
...
function Prat_Sounds:OnModuleEnable()	
	self:RegisterEvent(Prat.Events.OUTBOUND)	
...
local media = PRAT_LIBRARY(PRATLIB.MEDIA)
