...
L:RegisterTranslations("esES", function() return {
    ...
    ["Chat window justification options."] = "Opciones de justificaci\195\179n para la ventana de chat",
...
-- create prat module
Prat_Paragraph = Prat:NewModule(PRAT_MODULE)
Prat_Paragraph.revision = tonumber(string.sub("$Revision: 51543 $", 12, -3))
...
Prat_Paragraph.Categories = { cat.TEXT, cat.FORMATTING,}
