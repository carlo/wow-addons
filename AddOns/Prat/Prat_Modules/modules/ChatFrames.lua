...
-- create prat module
Prat_ChatFrames = Prat:NewModule(PRAT_MODULE)
Prat_ChatFrames.revision = tonumber(string.sub("$Revision: 51543 $", 12, -3))
...
Prat_ChatFrames.Categories = { cat.FRAME, cat.FORMATTING, cat.BEHAVIOR }
