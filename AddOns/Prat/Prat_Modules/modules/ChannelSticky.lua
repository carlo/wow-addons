...
-- create prat module
Prat_ChannelSticky = Prat:NewModule(PRAT_MODULE)
Prat_ChannelSticky.revision = tonumber(string.sub("$Revision: 51543 $", 12, -3))
...
Prat_ChannelSticky.Categories = { cat.CHANNEL, cat.BEHAVIOR }
...
function Prat_ChannelSticky:OnModuleEnable()
    ...
    self:RegisterEvent("Prat_OutboundChat")
