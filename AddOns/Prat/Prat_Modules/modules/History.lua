...
-- create prat module
Prat_History = Prat:NewModule(PRAT_MODULE)
Prat_History.revision = tonumber(string.sub("$Revision: 51543 $", 12, -3))
...
Prat_History.Categories	= { cat.INFO, cat.FRAME, cat.BEHAVIOR }	-- eg { cat.TEXT, cat.INFO }
