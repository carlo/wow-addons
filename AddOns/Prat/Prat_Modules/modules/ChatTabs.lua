...
-- create prat module
Prat_ChatTabs = Prat:NewModule(PRAT_MODULE)
Prat_ChatTabs.revision = tonumber(string.sub("$Revision: 51543 $", 12, -3))
...
Prat_ChatTabs.Categories = { cat.FRAME }
            ...
            displaymode = {
                ...
                args = {
                    chat1 = {
                        ...
                        validate = {["ALWAYS"] = L["Always"], ["HIDDEN"] = L["Hidden"], ["DEFAULT"] = L["Default"]},
                    },
                    chat2 = {
