...
Prat_ServerNames.revision = tonumber(string.sub("$Revision: 51543 $", 12, -3))
...
function Prat_ServerNames:ADDON_LOADED()
    Glory = PRAT_LIBRARY:HasInstance(PRATLIB.PVP, false) and PRAT_LIBRARY(PRATLIB.PVP)
...
function Prat_ServerNames:BuildServerOptions()
    ...
    if Glory then 
        ...
        opts.noglory = {
			...
			func = function() PRAT_LIBRARY:GetInstance(PRATLIB.PVP) end,            
        }
    end
