...
L:RegisterTranslations("esES", function() return {
	...
	["Toggle showing timestamp on and off for each window."] = "Muestra la hora en cada ventana",
	["Show ChatFrame%d Timestamp"] = "Mostrar hora en chat %d",
	["Toggle showing timestamp on and off for chat window %d."] = "Muestra la hora en la ventana de chat %d",
	...
	["Set timestamp format (strftime) for each chat window. See here for more details: http://fin.instinct.org/prat/timestamps/"] = "Establece el formato de hora (strftime) para cada ventana de chat. See here for more details: http://fin.instinct.org/prat/timestamps/",
	["Format ChatFrame%d Timestamp"] = "Formato de Hora en chat %d",
	["Set format of timestamp (strftime). See here for more details: http://fin.instinct.org/prat/timestamps/"] = "Establece el formato de hora (strftime) para la ventana de chat %d. See here for more details: http://fin.instinct.org/prat/timestamps/",
	["Format All Timestamps"] = "Formatear todas las Horas",
	["Set timestamp format (strftime) for all chat windows. See here for more details: http://fin.instinct.org/prat/timestamps/"] = "Establece el formato de hora (strftime) para todas las ventanas de chat. See here for more details: http://fin.instinct.org/prat/timestamps/",
	["Show Space"] = "Mostrar Espacio",
	["Toggle adding space after timestamp."] = "A𠣥 un espacio tras la Hora",
	["Color Timestamp"] = "Colorear Hora",
	["Toggle the coloring the timestamp on and off."] = "Colorea la Hora",
	["Set Timestamp Color"] = "Color",
	["Sets the color of the timestamp."] = "Cambia el color de la Hora",
	["Use Local Time"] = "Usar Hora Local",
	["Toggle using local time on and off."] = "Usar Hora Local",
	["prepend_name"] = "Hora delante",
	["prepend_desc"] = "Pone la hora al inicio del chat",
	["show_name"] = "Mostrar",
	["show_desc"] = "Muestra la hora en cada ventana.",
	["show_perframename"] = "Mostrar hora en %s ",
	["show_perframedesc"] = "Muestra la hora en la ventana de %s ",
	["format_name"] = "Formato",
	["format_desc"] = "Establece el formato de hora (strftime) para cada ventana de chat.",
	["format_perframename"] = "Formato de Hora en %s ",
	["format_perframedesc"] = "Establece el formato de hora (strftime) para la ventana de %s .",
	["space_name"] = "Mostrar Espacio",
	["space_desc"] = "A𠣥 un espacio tras la Hora.",
...
Prat_Timestamps = Prat:NewModule(PRAT_MODULE)
Prat_Timestamps.revision = tonumber(string.sub("$Revision: 55577 $", 12, -3))

-- Prat categories relevant to this module. list at: http://groups.google.com/group/wow-prat/web/prat-categories
Prat_Timestamps.Categories	= { cat.COLORS, cat.FORMATTING, cat.TEXT, cat.INFO }	-- eg { cat.TEXT, cat.INFO }
...
function Prat_Timestamps:AddMessage(frame, text, ...)
	...
	if self.db and self.db.profile.show and self.db.profile.show[id] and not Prat.loading then
