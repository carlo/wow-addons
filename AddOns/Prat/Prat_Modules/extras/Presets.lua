...
Prat_Presets.revision = tonumber(string.sub("$Revision: 52215 $", 12, -3))

-- define key module values
Prat_Presets.moduleName		= L["Presets"]
Prat_Presets.consoleName	= string.lower(Prat_Presets.moduleName)
Prat_Presets.guiName		= Prat_Presets.moduleName
Prat_Presets.moduleHidden	= true
Prat_Presets.Categories	= { cat.FORMATTING, cat.BEHAVIOUR }
