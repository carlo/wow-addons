--[[
	...
	Revision: $Id: InfCommand.lua 3576 2008-10-10 03:07:13Z aesir $
...
Informant_RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.1.x_WotLK_Release/Informant/InfCommand.lua $", "$Rev: 3576 $")
