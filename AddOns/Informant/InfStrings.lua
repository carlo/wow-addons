--[[
	...
	AddOn: Informant
	Revision: $Id: InfStrings.lua 2193 2007-09-18 06:10:48Z mentalpower $
	Version: 5.0.PRE.2544 (BillyGoat)
...
InformantLocalizations = {
	...
	enUS = {
		...
		["HelpLocale"]	= "Changes the locale that is used to display Informant messages. Note that this effects the locale setting for all Auctioneer addons.";
	...
	ruRU = {
		...
		["GuiInfoLink"]	= "Показывать уровень предмета";
		...
		["FrmtInfoQuest"]	= "Квестовый предмет в %d квестах\n";
