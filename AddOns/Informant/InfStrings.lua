--[[
	...
	AddOn: Informant
	Revision: $Id: InfStrings.lua 3581 2008-10-11 12:36:19Z Norganna $
...
Informant_RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.1.x_WotLK_Release/Informant/InfStrings.lua $", "$Rev: 3581 $")
...
InformantLocalizations = {
	...
	csCZ = {
		...
		["OptLocale"]	= "<jazyk>";
		["ShowIcon"]	= "ukaz-ikonu";
		["ShowILevel"]	= "zobraz-level";
		["ShowLink"]	= "zobraz-link";
		...
		-- Section: Help Text
		["GuiDefaultAll"]	= "Obnov všechna výchozí nastavení Informanta";
		["GuiDefaultAllButton"]	= "Obnov vše";
		["GuiDefaultAllHelp"]	= "Klikni zde a Informant vrátí všechna nastavení na výchozí hodnoty. POZOR: Nelze vrátit!";
		["GuiDefaultOption"]	= "Obnov toto nastaveni";
		["GuiEmbed"]	= "Vkládat informace do nápověd";
		["GuiEmbedHeader"]	= "Vkládat";
		["GuiInfoHeader"]	= "Dodatečné informace";
		["GuiInfoHelp"]	= "Řídí zobrazování dodatečných informací v nápovědách";
		["GuiInfoIcon"]	= "Zobraz ikonu inventáře";
		["GuiInfoILevel"]	= "Zobrazovat \"level\" předmětu";
		["GuiInfoLink"]	= "Zobrazovat \"link\" předmětu";
		["GuiInfoMerchant"]	= "Zobrazovat obchodníky";
		["GuiInfoQuest"]	= "Zobraz informace o Questu";
		["GuiInfoStack"]	= "Zobrazovat velikost balíčku (stack-size)";
		["GuiInfoUsage"]	= "Zobrazovat informace o využití";
		["GuiLocale"]	= "Nastavit jazyk";
		["GuiMainEnable"]	= "Zapnout Informant";
		["GuiMainHelp"]	= "Obsahuje nastavení pro Informant - AddOn, zobrazující podrobné informace o předmětech";
		["GuiOtherHeader"]	= "Další nastavení";
		["GuiOtherHelp"]	= "Vedlejší nastavení Informanta";
		...
		["GuiVendor"]	= "Zobrazovat ceny u obchodníků";
		["GuiVendorBuy"]	= "Zobrazovat nákupní cenu u obchodníků";
		["GuiVendorHeader"]	= "Ceny u obchodníků";
		["GuiVendorHelp"]	= "Nastavení kolem cen u obchodníků.";
		["GuiVendorSell"]	= "Zobrazovat prodejní cenu u obchodníků";
		["HelpDefault"]	= "Vrátí toto nastavení Informanta na výchozí hodnotu. Můžeš také zadat klíčové slovo \"all\" pro návrat všech nastavení na výchozí hodnoty.";
		["HelpDisable"]	= "Informant se přestane nahrávat při loginu postavy.";
		["HelpEmbed"]	= "Vkládat text do původní nápovědy (Pozn: některé vlastnosti se tím vypnou)";
		["HelpIcon"]	= "Vyber jestli se ma ukazovat ikona inventare";
		["HelpILevel"]	= "Nastaví zda se bude zobrazovat \"level\" předmětu";
		["HelpLink"]	= "Nastaví zda se bude zobrazovat \"link\" předmětu";
		["HelpLocale"]	= "Změní jazyk pro zobrazování zpráv Informatu";
		...
		["FrameTitle"]	= "Informace o předmětu";
		["FrmtActDefault"]	= "Toto nastavení Informanta bylo vráceno na původní hodnotu.";
		["FrmtActDefaultall"]	= "Všechna nastavení Informanta byla vrácena na původní hodnoty.";
		["FrmtActDisable"]	= "Nezobrazuji data předmětu o %s";
		["FrmtActEnable"]	= "Zobrazuji data předmětu o %s";
		["FrmtActEnabledOn"]	= "Zobrazuji o předmětu %s na %s;";
		["FrmtActSet"]	= "Nastavit %s na \"%s\"";
		["FrmtActUnknown"]	= "Neznámý příkaz nebo klíčové slovo: '%s'";
		["FrmtInfoBuy"]	= "Koupit od obchodníka";
		["FrmtInfoBuymult"]	= "Kup %d (po %s za kus)";
		["FrmtInfoClass"]	= "Třída: %s";
		["FrmtInfoItemLevel"]	= "\"level\" předmětu: %d";
		["FrmtInfoItemLink"]	= "\"Link\": %s";
		["FrmtInfoMerchants"]	= "Prodává %d obchodníků";
		["FrmtInfoQuest"]	= "Quest item v %d questech";
		["FrmtInfoSell"]	= "Prodat obchodníkovi";
		["FrmtInfoSellmult"]	= "Prodej %d (po %s za kus)";
		["FrmtInfoStx"]	= "Balíčkuje se po %d";
		["FrmtInfoUse"]	= "Používá se pro: %s";
		["FrmtUnknownLocale"]	= "Zadaný jazyk ('%s') není znám. Platné hodnoty pro jazyk jsou:";
		["FrmtWelcome"]	= "Informant v%s nahrán";
		["InfoHeader"]	= "Informace o |cff%s%s|r";
		["InfoNoItem"]	= "Nejprve přesuň myš nad předmět, a pak stiskni aktivační klávesu";
		["InfoPlayerMade"]	= "Vytváří %s se schopností na úrovni %d ";
		["InfoQuestHeader"]	= "Využito v %d questech:";
		["InfoQuestName"]	= "  %d for \"%s\" (level %d)";
		["InfoQuestSource"]	= "Quest data dodal/a";
		["InfoVendorHeader"]	= "Ke koupi u %d obchodníků:";
		["InfoVendorName"]	= "%s";
	...
	deDE = {
		...
		["HelpZeroMerchants"]	= "Schaltet die Anzeige, wenn kein Händler eines Items bekannt ist, ein/aus.";
		...
		["FrmtInfoNoKnownMerchants"]	= "Wird von keinem bekannten Händler verkauft";
		...
		["InfoQuestLineMult"]	= "%d benötigt: %s";
	...
	enUS = {
		...
		["InfoQuestLine"]	= "Quest: %s";
		["InfoQuestLineMult"]	= "%d needed: %s\n";
		["InfoQuestName"]	= "  %d for \"%s\" (level %d)";
		["InfoQuestRequiresHeader"]	= "Required for %d quests:";
		["InfoQuestRewardsHeader"]	= "Reward from %d quests:";
		["InfoQuestSource"]	= "Quest data supplied by";
		["InfoQuestStartsHeader"]	= "Starts a quest:";
		["InfoUntransQuest"]	= "Unknown quest: ID #%d";
	...
	esES = {
		...
		["StatOff"]	= "Ocultando información sobre objetos";
		["StatOn"]	= "Mostrando la información de objetos configurada";
		...
		["GuiLocale"]	= "Establecer localización a";
		["GuiMainEnable"]	= "Activar Informant";
		["GuiMainHelp"]	= "Contiene ajustes para Informant \nun accesorio que muestra información detallada sobre los objetos";
		["GuiOtherHeader"]	= "Otras Opciones";
		["GuiOtherHelp"]	= "Otras Opciones de Informant";
		["GuiReloadui"]	= "Recargar Interfaz";
		["GuiReloaduiButton"]	= "Recargar";
		["GuiReloaduiFeedback"]	= "Recargando el Interfaz de WoW";
		["GuiReloaduiHelp"]	= "Haz clic aquí para recargar el interfaz de WoW tras haber seleccionado una localización diferente para que el lenguaje en esta pantalla de configuración concuerde con el que has seleccionado. Nota: Esta operación puede llevar unos minutos.";
		["GuiVendor"]	= "Mostrar Precios de Vendedores";
		["GuiVendorBuy"]	= "Mostrar precios de compra de vendedores";
		["GuiVendorHeader"]	= "Precios de Vendedor";
		["GuiVendorHelp"]	= "Opciones relacionadas con los precios de compra/venta de PNJs.";
		["GuiVendorSell"]	= "Mostrar precios de venta de vendedores";
		["HelpDefault"]	= "Establece una opción a su valor por defecto. Puedes también especificar la palabra clave especial \"todo\" para establecer todas las pciones a sus valores por defecto.";
		["HelpDisable"]	= "Impide que Informant se cargue automáticamente la próxima vez que te conectes";
		["HelpEmbed"]	= "Inserta el texto en la caja de ayuda original del juego (nota: Algunas funciones son desactivadas cuando esta opción es seleccionada)";
		["HelpIcon"]	= "Determina si se muestra el icono de inventario del objeto";
		["HelpILevel"]	= "Determina si se muestra el nivel del objeto";
		["HelpLink"]	= "Determina si se muestra el enlace del objeto";
		["HelpLocale"]	= "Cambia la localización que es usada para mostrar los mensajes de Informant";
		["HelpMerchant"]	= "Determina si se muestran los mercaderes que venden el objeto";
		["HelpOnoff"]	= "Activa y desactiva la visualización de información";
		["HelpQuest"]	= "Determina si se muestran el uso de los objetos en misiones";
		["HelpStack"]	= "Determina si se muestra el tamaño máximo del paquete";
		["HelpUsage"]	= "Determina si se muestra el uso del objeto en profesiones";
		...
		-- Section: Keybinding Text
		["BindingHeader"]	= "Informant";
		["BindingTitle"]	= "Activar la ventana de información";
		...
		["FrmtInfoBuy"]	= "Compra en vendedor";
		...
		["FrmtInfoStx"]	= "Amontonable en lotes de %d";
		["FrmtInfoUse"]	= "Usado para: %s";
		["FrmtUnknownLocale"]	= "La localización que has especificado ('%s') no es válida. Las localizaciones válidas son:";
		["FrmtWelcome"]	= "Informant versión %s cargado";
		["InfoHeader"]	= "Información sobre |cff%s%s|r";
		["InfoNoItem"]	= "Primero debes mover el cursor sobre un objeto, luego pulsar la tecla de activación";
		["InfoPlayerMade"]	= "Hecho por %s nivel %d";
		["InfoQuestHeader"]	= "Artí­culo usado en %d misiones:";
		["InfoQuestLine"]	= "Misión: %s";
		["InfoQuestLineMult"]	= "%d necesitado: %s";
		["InfoQuestName"]	= "  %d para \"%s\" (nivel %d)";
		["InfoQuestRequiresHeader"]	= "Requerido en %d misiones:";
		["InfoQuestRewardsHeader"]	= "Premio en %d misiones:";
		["InfoQuestSource"]	= "Información sobre misiones suministrada por";
		["InfoQuestStartsHeader"]	= "Comienza una misión:";
		["InfoUntransQuest"]	= "Misión desconocida: ID #%d";
		["InfoVendorHeader"]	= "Disponible en %d mercaderes:";
		["InfoVendorName"]	= "%s";
		...
		["AdditScroll"]	= "Pergamino";
		["SkillAlchemy"]	= "Alqui­mia";
		["SkillBlacksmithing"]	= "Herrerí­a";
		["SkillCooking"]	= "Cocina";
		["SkillDruid"]	= "Hechizos de Druidas";
	...
	frFR = {
		...
		["HelpZeroMerchants"]	= "Selectionner si affichage ou pas quand aucun marchand connu ne vend un objet";
		...
		["FrmtInfoNoKnownMerchants"]	= "Vendu par aucun marchands connus";
		...
		["InfoQuestLine"]	= "Quête: %s";
		["InfoQuestLineMult"]	= "%d requis: %s";
		["InfoQuestName"]	= "%d pour \"%s\" (niveau %d)";
		["InfoQuestRequiresHeader"]	= "Requis pour %s quêtes:";
		["InfoQuestRewardsHeader"]	= "Récompense de %d quêtes:";
		["InfoQuestSource"]	= "Données de quête fournies par";
		["InfoQuestStartsHeader"]	= "Débute une quête";
		["InfoUntransQuest"]	= "Quête inconnue : ID #%d";
	...
	koKR = {
		...
		["HelpILevel"]	= "아이템 레벨 표시 또는 숨김 선택";
		["HelpLink"]	= "아이템 링크 표시 또는 숨김 선택";
		...
		["InfoQuestLine"]	= "퀘스트: %s";
		["InfoQuestLineMult"]	= "%d 요구됨: %s";
		["InfoQuestName"]	= "\"%s\"의 %d (레벨 %d)";
		["InfoQuestRequiresHeader"]	= "%d개의 퀘스트 필요함:";
		["InfoQuestRewardsHeader"]	= "%d개의 퀘스트 보상:";
		["InfoQuestSource"]	= "퀘스트 자료가 제공되는 곳:";
		["InfoQuestStartsHeader"]	= "시작 퀘스트:";
		["InfoUntransQuest"]	= "알수없는 퀘스트: ID #%d";
	...
	trTR = {
		...
		["CmdToggle"]	= "degistir";
		["OptLocale"]	= "<yerel>";
		["ShowLink"]	= "goster-link";
		["ShowMerchant"]	= "goster-tuccar";
		["ShowName"]	= "goster-isim";
		...
		["StatOff"]	= "item bilgileri gösterilmez";
		["StatOn"]	= "item bilgileri gösterilecek şekilde ayarlandı";
		...
		-- Section: Help Text
		["GuiDefaultAllButton"]	= "Tumunu Sifirla";
		["GuiDefaultOption"]	= "Ayari sifirla";
	...
	zhCN = {
		...
		["ShowZeroMerchants"]	= "show-zero-merchants显示没有商人";
		...
		["FrmtInfoNoKnownMerchants"]	= "没有已知商人出售";
	...
	zhTW = {
		...
		["InfoQuestStartsHeader"]	= "開啟一個任務:";
		["InfoUntransQuest"]	= "不明的任務號碼 #%d";
