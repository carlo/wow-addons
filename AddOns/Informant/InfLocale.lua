--[[
	...
	Revision: $Id: InfLocale.lua 2225 2007-09-24 12:09:54Z norganna $
...
Informant_RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Informant/InfLocale.lua $", "$Rev: 2225 $")
