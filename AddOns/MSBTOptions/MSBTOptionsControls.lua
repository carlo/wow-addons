...
-- ****************************************************************************
-- Recursively update the child frame levels so that everything is shown
-- properly when the parent changes.
-- ****************************************************************************
local function UpdateChildFrameLevels(frame, ...)
 ...
 for i = 1, numChildren do
  child = select(i, ...);
  child:SetFrameLevel(frameLevel + 1);
  UpdateChildFrameLevels(child, child:GetChildren());
 end
end
...
local function Listbox_CreateLine(this)
 ...
 UpdateChildFrameLevels(line, line:GetChildren());
...
local function Dropdown_OnClick(this)
 ...
 UpdateChildFrameLevels(dropdownListboxFrame, dropdownListboxFrame:GetChildren());
...
-- Protected Functions.
module.UpdateChildFrameLevels	= UpdateChildFrameLevels;
