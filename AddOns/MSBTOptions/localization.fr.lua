...
--obj["conditionParam"]	= { label="Param\195\168tre:", tooltip="The parameter for the selected condition type."};
...
obj["SelfHealth"]				= "Vie du joueur %";
obj["SelfMana"]					= "Mana du joueur %";
obj["PetHealth"]				= "Vie du familier %";
obj["EnemyHealth"]				= "Vie de la cible ennemie %";
obj["FriendlyHealth"]			= "Vie de la cible amie %";
...
obj["SearchPattern"]			= "Expression de recherche";
