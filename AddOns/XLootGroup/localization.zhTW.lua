...
L:RegisterTranslations("zhTW", function()
	return {
		...
		["Size of the Need, Greed, and Pass buttons"] = "[需求][貪婪][略過]按鍵大小",
		["XLoot Group"] = "XLoot隊伍",
		...
		["Prevent rolls on BoP items"] = "防止對BoP物品擲骰",
		["Locks the Need and Greed buttons for any BoP items"] = "對任何BoP物品鎖定[需求]和[貪婪]按鍵",
	}
end)
