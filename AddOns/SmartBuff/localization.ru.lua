...
SMARTBUFF_TEMPLATES = {"Соло", "Группа", "Рейд", "Поле битвы", "ОБ", "Оня", "ЛКТ", "Накс", "АК", "ЗГ", "Своё 1", "Своё 2", "Своё 3", "Своё 4", "Своё 5"};
SMARTBUFF_INSTANCES = {"Огненная Бездна", "Логово Ониксии", "Логово Крыла Тьмы", "Наксрамас", "Ан'Кираж", "Зул'Гуруб", "Альтеракская долина", "Низина Арати", "Ущелье Песни Войны", "Острие клинка", "Арена Награнда"};
