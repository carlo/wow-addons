...
SMARTBUFF_INSTANCES = {"Molten Core", "Onyxia's Lair", "Blackwing Lair", "Naxxramas", "Ahn'Qiraj", "Zul'Gurub", "Alterac Valley", "Arathi Basin", "Warsong Gulch", "Blade's Edge", "Nagrand Arena"};
