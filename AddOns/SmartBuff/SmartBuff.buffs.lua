...
function SMARTBUFF_InitSpellList()
  ...
  if (SMARTBUFF_PLAYERCLASS == "DRUID") then
    SMARTBUFF_BUFFLIST = {
      {SMARTBUFF_MOTW, 30, SMARTBUFF_CONST_GROUP, {1,10,20,30,40,50,60,70,80}, "WPET", SMARTBUFF_GOTW, 60, {50,60,70,80}, {SMARTBUFF_WILDBERRIES,SMARTBUFF_WILDTHORNROOT,SMARTBUFF_WILDQUILLVINE,SMARTBUFF_WILDQUILLVINE}},
      {SMARTBUFF_THORNS, 10, SMARTBUFF_CONST_GROUP, {6,14,24,34,44,54,64,74}, "HUNTER;ROGUE;MAGE;PRIEST;PALADIN;WARLOCK;WPET;" .. SMARTBUFF_DRUID_MOONKIN},
  ...
  if (SMARTBUFF_PLAYERCLASS == "PRIEST") then
    SMARTBUFF_BUFFLIST = {
      {SMARTBUFF_PWF, 30, SMARTBUFF_CONST_GROUP, {1,12,24,36,48,60,70,80}, "WPET", SMARTBUFF_POF, 60, {48,60,70,80}, {SMARTBUFF_HOLYCANDLE,SMARTBUFF_SACREDCANDLE,SMARTBUFF_SACREDCANDLE,SMARTBUFF_SACREDCANDLE}},
      {SMARTBUFF_SP, 10, SMARTBUFF_CONST_GROUP, {30,42,56,68,76}, "WPET", SMARTBUFF_POSP, 20, {56,70,77}, {SMARTBUFF_SACREDCANDLE,SMARTBUFF_SACREDCANDLE,SMARTBUFF_SACREDCANDLE}},
      {SMARTBUFF_INNERFIRE, 10, SMARTBUFF_CONST_SELF},
      {SMARTBUFF_DS, 30, SMARTBUFF_CONST_GROUP, {40,42,54,60,70,80}, "ROGUE;WARRIOR;HPET;WPET", SMARTBUFF_POS, 60, {60,70,80}, {SMARTBUFF_SACREDCANDLE,SMARTBUFF_SACREDCANDLE,SMARTBUFF_SACREDCANDLE}},
      {SMARTBUFF_PWS, 0.5, SMARTBUFF_CONST_GROUP, {6,12,18,24,30,36,42,48,54,60,65,70,75,80}, "MAGE;WARLOCK;ROGUE;PALADIN;WARRIOR;DRUID;HUNTER;SHAMAN;HPET;WPET"},
  ...
  if (SMARTBUFF_PLAYERCLASS == "MAGE") then
    SMARTBUFF_BUFFLIST = {
      {SMARTBUFF_AI, 30, SMARTBUFF_CONST_GROUP, {1,14,28,42,56,70,80}, "ROGUE;WARRIOR;HPET;WPET", SMARTBUFF_AB, 60, {56,70,80}, {SMARTBUFF_ARCANEPOWDER,SMARTBUFF_ARCANEPOWDER,SMARTBUFF_ARCANEPOWDER}},
  ...
  if (SMARTBUFF_PLAYERCLASS == "SHAMAN") then
    SMARTBUFF_BUFFLIST = {
      ...
      {SMARTBUFF_EARTHSHIELD, 10, SMARTBUFF_CONST_GROUP, {50,60,70,75,80}, "WARRIOR;DRUID;SHAMAN;HUNTER;ROGUE;MAGE;PRIEST;PALADIN;WARLOCK;HPET;WPET"},
  ...
  if (SMARTBUFF_PLAYERCLASS == "PALADIN") then
    SMARTBUFF_BUFFLIST = {
      ...
      {SMARTBUFF_BOM, 10, SMARTBUFF_CONST_GROUP, {4,12,22,32,42,52,60,70,73,79}, "DRUID;MAGE;PRIEST;SHAMAN;WARLOCK;WPET", SMARTBUFF_GBOM, 30, {52,60,70,73,79}, {SMARTBUFF_SYMBOLOFKINGS,SMARTBUFF_SYMBOLOFKINGS,SMARTBUFF_SYMBOLOFKINGS,SMARTBUFF_SYMBOLOFKINGS,SMARTBUFF_SYMBOLOFKINGS} },
      {SMARTBUFF_BOW, 10, SMARTBUFF_CONST_GROUP, {14,24,34,44,54,60,65,71,77}, "ROGUE;WARRIOR;HPET;WPET", SMARTBUFF_GBOW, 30, {54,60,65,71,77}, {SMARTBUFF_SYMBOLOFKINGS,SMARTBUFF_SYMBOLOFKINGS,SMARTBUFF_SYMBOLOFKINGS,SMARTBUFF_SYMBOLOFKINGS,SMARTBUFF_SYMBOLOFKINGS} },
      {SMARTBUFF_BOK, 10, SMARTBUFF_CONST_GROUP, {20}, "WPET", SMARTBUFF_GBOK, 30, {60}, {SMARTBUFF_SYMBOLOFKINGS} },
      {SMARTBUFF_BOSAN, 10, SMARTBUFF_CONST_GROUP, {30}, "DRUID;HUNTER;MAGE;PRIEST;ROGUE;SHAMAN;WARLOCK;HPET;WPET", SMARTBUFF_GBOSAN, 30, {60}, {SMARTBUFF_SYMBOLOFKINGS} },
      {SMARTBUFF_BOSAL, 10, SMARTBUFF_CONST_GROUP, {26}, "WARRIOR;HPET;WPET"},
      --{SMARTBUFF_BOF, 0.165, SMARTBUFF_CONST_GROUP, {18}},
      --{SMARTBUFF_BOP, 1, SMARTBUFF_CONST_GROUP, {10,24,38}},
      {SMARTBUFF_SOCOMMAND, 2, SMARTBUFF_CONST_SELF},
      {SMARTBUFF_SOFURY, 2, SMARTBUFF_CONST_SELF},
      {SMARTBUFF_SOJUSTICE, 2, SMARTBUFF_CONST_SELF},
      {SMARTBUFF_SOLIGHT, 2, SMARTBUFF_CONST_SELF},
      {SMARTBUFF_SORIGHTEOUSNESS, 2, SMARTBUFF_CONST_SELF},
      {SMARTBUFF_SOWISDOM, 2, SMARTBUFF_CONST_SELF},
      {SMARTBUFF_SOTCRUSADER, 2, SMARTBUFF_CONST_SELF},
      {SMARTBUFF_SOVENGEANCE, 2, SMARTBUFF_CONST_SELF},
      {SMARTBUFF_SOBLOOD, 2, SMARTBUFF_CONST_SELF},
      {SMARTBUFF_SOCORRUPTION, 2, SMARTBUFF_CONST_SELF},
      {SMARTBUFF_SOMARTYR, 2, SMARTBUFF_CONST_SELF},
