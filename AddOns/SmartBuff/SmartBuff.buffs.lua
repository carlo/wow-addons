...
function SMARTBUFF_InitItemList()
  ...
  SMARTBUFF_SPELLSTONE          = GetItemInfo(41191); --"Spellstone"
  SMARTBUFF_MASTERFIRESTONE     = GetItemInfo(40773); --"Master Firestone"
...
function SMARTBUFF_InitSpellList()
  ...
  if (SMARTBUFF_PLAYERCLASS == "WARLOCK") then
    SMARTBUFF_BUFFLIST = {
      ...
      {SMARTBUFF_MASTERFIRESTONE, 60, SMARTBUFF_CONST_INV}
    };
