...
SMARTBUFF_INSTANCES = {"N\195\186cleo de Magma", "Guarida de Onyxia", "Guarida alanegra", "Naxxramas", "Ahn'Qiraj", "Zul'Gurub", "Valle Alterac", "Cuenca de Arathi", "Garganta Grito de Guerra", "Filo de la navaja", "Arena de Nagrand"};
...
SMARTBUFF_OFT_ADVGRPBUFFCHECK = "Comprobar buff de grupo";
SMARTBUFF_OFT_ADVGRPBUFFRANGE = "Comprobar rango de grupo";
...
SMARTBUFF_OFTT_ADVGRPBUFFCHECK = "La comprobaci\195\179n avanzada de los buffs de grupo tambi\195\169n busca\nsobre buffs simples durante la comprobaci\195\179n de buffs.";
SMARTBUFF_OFTT_ADVGRPBUFFRANGE = "La comprobaci\195\179n avanzada del rango del grupo tambi\195\169n busca\nsi cada jugador est\195\161 en rango.";
