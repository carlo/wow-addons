...
EQL3_QUEST_TRACKER = "Quest Tracker";
...
-- new to 3.6.2
EQL3_SHOW_TRACKER_HEADER = "Always Show Tracker Header";
EQL3_ACTIVE_TRACKER = "Active Tracker";
EQL3_ACTIVE_TRACKER_INFO = "Hold the Alt button and hover a quest in the tracker to display the description in the tooltip.\n\nLeft-Clicking will open the Log.\nRight-Clicking will untrack the quest.";
