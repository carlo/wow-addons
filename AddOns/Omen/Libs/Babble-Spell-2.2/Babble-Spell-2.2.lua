...
local MINOR_VERSION = tonumber(string.sub("$Revision: 55178 $", 12, -3))
...
BabbleSpell:RegisterTranslations("deDE", function()
	return {
		...
		["Improved Holy Shield"] = "Verbessertes Heiliges Schild",
...
--		["Judgement of Reckoning"] = true,
		...
		["Remove Lesser Curse"] = "Eliminar maldición inferior", -- before 2.2 "Deshacer maldici\195\179n inferior",
		["Rend"] = "Desgarrar",
		["Renew"] = "Renovar",
