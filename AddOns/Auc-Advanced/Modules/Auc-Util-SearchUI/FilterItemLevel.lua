--[[
	...
	Revision: $Id: FilterItemLevel.lua 3727 2008-10-29 05:08:46Z RockSlice $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.1.x_WotLK_Release/Auc-Util-SearchUI/FilterItemLevel.lua $", "$Rev: 3727 $")
