--[[
	...
	Revision: $Id: FilterItemQuality.lua 3668 2008-10-22 02:53:04Z RockSlice $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.1.x_WotLK_Release/Auc-Util-SearchUI/FilterItemQuality.lua $", "$Rev: 3668 $")
