--[[
	Auctioneer Advanced - Search UI - Filter IgnoreItemauctionhistory
	Version: 5.1.3824 (SnaggleTooth)
	Revision: $Id: FilterItemAuctionHistory.lua 3653 2008-10-19 05:32:55Z dinesh $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.1.x_WotLK_Release/Auc-Util-SearchUI/FilterItemAuctionHistory.lua $", "$Rev: 3653 $")
