--[[
	...
	Revision: $Id: OutlierFilter.lua 3747 2008-11-01 22:38:12Z kandoko $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.1.x_WotLK_Release/Auc-Filter-Outlier/OutlierFilter.lua $", "$Rev: 3747 $")
