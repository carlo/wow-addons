--[[
	...
	Revision: $Id: AskPrice.lua 3767 2008-11-05 17:57:29Z Norganna $
...
function private.GetVersion()
	return tonumber(("$Revision: 3767 $"):match("(%d+)")), (AucAdvanced.GetCurrentRevision()) --We just want the first return from GetCurrentRevision()
end
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.1.x_WotLK_Release/Auc-Util-AskPrice/AskPrice.lua $", "$Rev: 3767 $")
