--[[
	...
	Revision: $Id: ScanButton.lua 3576 2008-10-10 03:07:13Z aesir $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.1.x_WotLK_Release/Auc-Util-ScanButton/ScanButton.lua $", "$Rev: 3576 $")
