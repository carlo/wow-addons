--[[
	...
	Revision: $Id: Configator.lua 160 2008-11-08 01:52:36Z tem $
...
LibStub("LibRevision"):Set("$URL: http://svn.norganna.org/libs/trunk/Configator/Configator.lua $","$Rev: 160 $","5.1.DEV.", 'auctioneer', 'libs')
