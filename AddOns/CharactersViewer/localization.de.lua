--[[
   ...
   Date: $Date: 2007-05-27 21:28:56 -0400 (dim., 27 mai 2007) $
...
if (GetLocale() == "deDE") then
	...
	CHARACTERSVIEWER_TOOLTIP_DROPDOWN2 					= "Klicken um einen deiner anderen Charaktere vom\nselben Server auszuw\195\164hlen und im Fenster\ndes Charakteranzeigers darzustellen.";
	...
	CHARACTERSVIEWER_USAGE_SUBCMD[2]                = CHARACTERSVIEWER_SUBCMD_PREVIOUS .. " : " .. BINDING_NAME_CHARACTERSVIEWER_SWITCH_PREVIOUS;
	CHARACTERSVIEWER_USAGE_SUBCMD[3]                = CHARACTERSVIEWER_SUBCMD_NEXT .. " : " .. BINDING_NAME_CHARACTERSVIEWER_SWITCH_NEXT;
	CHARACTERSVIEWER_USAGE_SUBCMD[4]                = CHARACTERSVIEWER_SUBCMD_SWITCH .. " <arg1>: Zu Charakter <arg1> wechseln.";
	CHARACTERSVIEWER_USAGE_SUBCMD[5]                = CHARACTERSVIEWER_SUBCMD_BANK .. " : Bankinhalt anzeigen/verbergen";
	CHARACTERSVIEWER_USAGE_SUBCMD[6]						= CHARACTERSVIEWER_SUBCMD_BAGS .. " : Zeigt eine Liste mit den Taschengr\195\182\195\159en der einzelnen Charaktere an.";
	CHARACTERSVIEWER_USAGE_SUBCMD[7]						= CHARACTERSVIEWER_SUBCMD_BAGUSE .. " : Zeigt die Taschenbenutzug der einzelnen Charaktere an.";
