...
if (GetLocale() == "frFR") then
	...
	CHARACTERSVIEWER_USAGE_SUBCMD[4]					= " switch <arg1> : Changer au personnage <arg1>";
	CHARACTERSVIEWER_USAGE_SUBCMD[5]					= " bank : Affiche/cache la banque";
   ...
   --CHARACTERSVIEWER_USAGE_SUBCMD[7]             = " baguse : List the bag usage of each character";
	...
	CHARACTERSVIEWER_BANK_NOTSCANNED					= "Donn\195\169es de la banque non-disponible";
