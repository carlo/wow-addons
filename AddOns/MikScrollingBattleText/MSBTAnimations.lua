...
local function Display(message, saSettings, isSticky, colorR, colorG, colorB, fontSize, fontPath, outlineIndex, fontAlpha, texturePath)
 ...
 displayEvent.animationSpeed = (saSettings.animationSpeed or MSBTProfiles.currentProfile.animationSpeed) / 100;
 ...
 -- Set texture properties if there is a texture path.
 if (texturePath) then
...
-- ****************************************************************************
local function DisplayMessage(message, scrollArea, isSticky, colorR, colorG, colorB, fontSize, fontName, outlineIndex)
 ...
 Display(message, saSettings, isSticky, colorR / 255, colorG / 255, colorB / 255, fontSize, fontPath, outlineIndex, fontAlpha);
end
