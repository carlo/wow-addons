...
local L	=	LibStub("AceLocale-2.2"):new("beql")
...
--get the optiontable and register it
	AceConfigReg:RegisterOptionsTable(MODNAMESTRING, beql:MainOptionsTable(), MODNAMESTRING)
				...
				general	=	{
					...
					args	=	{
						DisableAddon	=	{
							...
							get	=	function(info) return true end, --beql:IsActive() end,
							set	=	function(info, newval) beql:Disableaddon(newval) end,
						},
						Spacher1	=	{
							type	=	'header',
							order	=	2,
						...
						SimpleQuestLog	=	{
							...
							set	=	function(info, newval) beql:DisableQuestLog(newval) end,
						...
						DisableTracker	=	{
							...
							set	=	function(info, newval) beql:Disabletracker(newval) end, 
							disabled	=	function(info) return not beql:IsActive() end,
						},
						EnableATracker	=	{
							type	=	'toggle',
					...
					desc	=	L["Options related to the Quest Log"],
						args	=	{
							...
							Locked	=	{
								...
								set	=	function(info, newval) beql:setmovable(newval) end,
							},
							SimpleQuestLog	=	{
								type	=	'toggle',
								order	=	3,
							...
							AlwaysMaximize	=	{
								...
								disabled	=	function(info) return beql.db.profile.alwaysminimize end,
							},
							AlwaysMinimize	=	{
								type	=	'toggle',
								order	=	6,
								...
								disabled	=	function(info) return beql.db.profile.alwaysmaximize end,
							},
							ShowLevel	=	{
								type	=	'toggle',
								order	=	7,
								...
								disabled	=	function(info) return beql.db.profile.disabled.showlevel end,
							},
							InfoOnQuestCompletion	=	{
								...
								set	=	function(info, newval) beql:setinfoonquestcomplete(newval) end,
							},
							QuestCompletionSound	=	{
								...
								disabled	=	function(info) return not beql.db.profile.InfoOnQuestCompletion end,
								args	=	{
									none	=	{
										type	=	'toggle',
										order	=	1,
				...
				qtracker	=	{
					...
					args	=	{
							...
							ShowTrackerHeader	=	{
								...
								set	=	function(info, newval) beql.db.profile.ShowTrackerHeader	=	newval QuestWatch_Update() end,
							},
							TrackerAutoResize	=	{
								type	=	'toggle',
								order	=	5,							
								...
								set	=	function(info, newval) beql.db.profile.TrackerAutoResize	=	newval QuestWatch_Update() end,
							},
							TrackerFixedWidth	=	{
								type	=	'range',
								order	=	6,
								...
								set	=	function(info, newval) beql.db.profile.TrackerFixedWidth	=	newval QuestWatch_Update() end,
								min	=	200,
								max	=	600,
								step	=	10,
							...
							AddNew	=	{
								...
								set	=	function(info, newval) beql.db.profile.AddNew	=	newval QuestWatch_Update() end,
							},
							AddUntracked	=	{
								type	=	'toggle',
								order	=	11,
							...
							ShowZonesInTracker	=	{
								...
								set	=	function(info, newval) beql.db.profile.ShowZonesInTracker	=	newval QuestWatch_Update() end,
							},			
							Spacing4	=	{
								type	=	'header',
								order	=	14,
							...
							RemoveFinished	=	{
								...
								set	=	function(info, newval) beql.db.profile.RemoveFinished	=	newval QuestWatch_Update() end,
							},
							...
							MinimizeFinished	=	{
								...
								set	=	function(info, newval) beql.db.profile.MinimizeFinished	=	newval QuestWatch_Update() end,
							},	
							HideCompletedOnly	=	{
								type	=	'toggle',
								order	=	17,
								...
								set	=	function(info, newval) beql.db.profile.HideCompletedOnly	=	newval QuestWatch_Update() end,
							...
							SortTrackerItems	=	{
								...
								set	=	function(info, newval) beql.db.profile.SortTrackerItems	=	newval beql:SortWatchedQuests() QuestWatch_Update() end,
							},
							Spacing5	=	{
								type	=	'header',
								order	=	19,
							...
							MarkerOptions	=	{
								...
								args	=	{
									ShowObjectiveMarkers	=	{	
										...
										set	=	function(info, newval) beql.db.profile.ShowObjectiveMarkers	=	newval QuestWatch_Update() end,
									...
									UseTrackerListing	=	{
										...
										set	=	function(info, newval) beql.db.profile.UseTrackerListing	=	newval QuestWatch_Update() end,
							...
							Colors	=	{
								...
								args	=	{
									BackgroundAlpha	=	{
										...
										set	=	function(info, newval) beql.db.profile.BackgroundAlpha	=	newval QuestWatch_Update() end,
									},								
									CustomBackgroundColor	=	{
										...
										set	=	function(info, newval) beql.db.profile.CustomBackgroundColor	=	newval QuestWatch_Update() end,
									...
									CustomZoneColor	=	{
										...
										set	=	function(info, newval) beql.db.profile.CustomZoneColor	=	newval QuestWatch_Update() end,
									},								
									ColorZone	=	{
										type	=	'color',
										order	=	7,
									...
									FadeColor	=	{
										...
										set	=	function(info, newval) beql.db.profile.FadeColor	=	newval QuestWatch_Update() end,
									},
									CustomObjetiveColor	=	{
										type	=	'toggle',
										order	=	10,
										...
										set	=	function(info, newval) beql.db.profile.CustomObjetiveColor	=	newval QuestWatch_Update() end,
									},										
									ColorObjectiveEmpty	=	{
										type	=	'color',
										order	=	11,
									...
									CustomHeaderColor	=	{
										...
										set	=	function(info, newval) beql.db.profile.CustomHeaderColor	=	newval QuestWatch_Update() end,
									},
									HeaderQuestLevelColor	=	{
										...
										set	=	function(info, newval) beql.db.profile.HeaderQuestLevelColor	=	newval QuestWatch_Update() end,
				...
				fubar	=	{
					...
					args	=	{
						...
						hideplugin=	{
							...
							get	=	function(info) return beql.db.profile.HideFuBarPlugin end,
							set	=	function(info, newval)
												beql.db.profile.HideFuBarPlugin	=	newval;
												if newval then
													beqlfu:Hide();
												else
													beqlfu:Show();
						...
						showIcon	=	{
							...
							get	=	function(info) return beqlfu:IsIconShown() end,
							set	=	function(info, newval) beqlfu:ToggleIconShown(newval) end,
						...
						showText	=	{
							...
							get	=	function(info) return beqlfu:IsTextShown() end,
							set	=	function(info, newval) beqlfu:ToggleTextShown(newval) end,
							disabled	=	function(info) return beql.db.profile.HideFuBarPlugin end,
						},
						showcoloredText	=	{
							type	=	'toggle',
							...
							get	=	function(info) return beqlfu:IsTextColored() end,
							set	=	function(info, newval) beqlfu:ToggleTextColored(newval) end,
							disabled	=	function(info) return beql.db.profile.HideFuBarPlugin end,
						},
						detachtooltip	=	{
							type	=	'toggle',
...
-- add Sounds to Options
	...
	for k, v in pairs (beql.sounds) do 
		i	=	i +1
		optionsmain.args.qlog.args.QuestCompletionSound.args[k]	=	{
			type	=	'toggle',
			name	=	k,
			desc	=	k,
			get	=	function(info) 
...
-- add locale to loacels options
	...
	for k in L:IterateAvailableLocales() do 
		...
		optionsmain.args.qlocales.args["locale"..k]	=	{
			type	=	'toggle',
			name	=	k,
		...
		for k,v in pairs(modularOptions) do
			...
			optionsmain.args[k]	=	(type(v) ==	"function") and v() or v
