...
function Outfitter.MinimapButton_DragStart(self)
	MCSchedulerLib:ScheduleUniqueRepeatingTask(0, Outfitter.MinimapButton_UpdateDragPosition, self)
end

function Outfitter.MinimapButton_DragEnd(self)
	MCSchedulerLib:UnscheduleTask(Outfitter.MinimapButton_UpdateDragPosition, self)
end
