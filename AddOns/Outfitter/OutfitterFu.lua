...
if not IsAddOnLoaded("FuBar") or IsAddOnLoaded("FuBar_OutfitterFu") then return end
...
function Outfitter._Fu:OnEnable()
   Outfitter:RegisterOutfitEvent('OUTFITTER_INIT', function (...) Outfitter.Fu:OutfitEvent(...) end)
   Outfitter:RegisterOutfitEvent('WEAR_OUTFIT', function (...) Outfitter.Fu:OutfitEvent(...) end)
   Outfitter:RegisterOutfitEvent('UNWEAR_OUTFIT', function (...) Outfitter.Fu:OutfitEvent(...) end)
...
function Outfitter._Fu:OnTextUpdate()
   ...
   local vEquippableItems = OutfitterItemList:GetEquippableItems()
