if GetLocale() == "deDE" then
	...
	Outfitter.cItemStatPhrases =
	{
		...
		["trefferwertung"] = {"MeleeHitRating", "SpellHitRating"},
		...
		["zaubermacht"] = {"SpellDmg", "ShadowDmg", "FireDmg", "FrostDmg", "ArcaneDmg", "NatureDmg", "Healing"},
	...
	Outfitter.c2HAxes = "Zweihandäxte"
	Outfitter.c2HMaces = "Zweihandstreitkolben"
	Outfitter.c2HSwords = "Zweihandschwerter"
