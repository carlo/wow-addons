Outfitter_cVersion = "3.6.0";
Outfitter_cTestVersion = "3.6.0b";
...
Outfitter_cSpecialOutfits = "Special occasions";
...
Outfitter_cArenaOutfit = "Battleground: Arena";
Outfitter_cEotSOutfit = "Battleground: Eye of the Storm";
Outfitter_cCityOutfit = "Around Town";
Outfitter_cSwimmingOutfit = "Swimming";
...
Outfitter_cEotS = "Eye of the Storm";
...
Outfitter_cSilvermoon = "Silvermoon City";
Outfitter_cExodar = "The Exodar";
Outfitter_cShattrath = "Shattrath City";
Outfitter_cAQ40 = "Ahn'Qiraj Temple";
...
Outfitter_cItemStatFormats =
{
	...
	{Format = "%+(%d+) Attack Power", Types = {"Attack", "RangedAttack"}},
	{Format = "Increases attack power by (%d+).", Types = {"Attack", "RangedAttack"}},
	{Format = "Increases ranged attack power by (%d+).", Types = {"RangedAttack"}},	
	
	{Format = "%+(%d+) Defense$", Types = {"Defense"}},
	...
	{Format = "%+(%d+) Defense Rating", Types = {"DefenseRating"}},
	
	{Format = "Improves critical strike rating by (%d+)", Types = {"MeleeCritRating"}},
	{Format = "Improves hit rating by (%d+)", Types = {"MeleeHitRating"}},
	
	{Format = "Increases your critical strike rating by %+?(%d+)", Types = {"MeleeCritRating"}},
	{Format = "Increases your hit rating by %+?(%d+)", Types = {"MeleeHitRating"}},
	{Format = "Increases your dodge rating by %+?(%d+)", Types = {"MeleeDodgeRating"}},
	{Format = "Increases your parry rating by %+?(%d+)", Types = {"MeleeParryRating"}},
	{Format = "Increases defense rating by %+?(%d+)", Types = {"DefenseRating"}},
	{Format = "Increases your shield block rating by %+?(%d+)", Types = {"ShieldBlockRating"}},
	{Format = "Increases your block rating by %+?(%d+)", Types = {"ShieldBlockRating"}},
	
	{Format = "Improves spell critical strike rating by (%d+)", Types = {"SpellCritRating"}},
	{Format = "Improves spell hit rating by (%d+)", Types = {"SpellHitRating"}},
	
	{Format = "%+(%d+) Spell Critical Strike Rating", Types = {"SpellCritRating"}},
};
...
Outfitter_cTotalStatsName = "Total Stats";
...
Outfitter_cRangedAttackStatName = "Ranged Attack Power";
...
Outfitter_cAutoSwitch = "Auto-Switch Outfits";
Outfitter_cAutoSwitchOnDescription = "Turn this off if you do not want equipment to automatically switch";
Outfitter_cAutoSwitchOffDescription = "Turn this on if you want equipment to automatically switch";
Outfitter_cTooltipInfo = "Show Tooltips";
Outfitter_cTooltipInfoOnDescription = "Turn this off if you do not want to display 'Used By:' information in Tooltip (This improves frame rate when mousing over Equipment)";
Outfitter_cTooltipInfoOffDescription = "Turn this on if you want to display 'Used By:' information in Tooltip";
Outfitter_cSlotPriorityTitle = "Slot priority";
Outfitter_cEnableSlotPriority = "Enable slot priority";
Outfitter_cRememberVisibility = "Helm and Cloak settings";
...
Outfitter_cEotSOutfitDescription = "This outfit will automatically be worn whenever you're in the Eye of the Storm battleground";
Outfitter_cCityOutfitDescription = "This outfit will automatically be worn whenever you're in a friendly major city";
Outfitter_cSwimmingOutfitDescription = "This outfit will automatically be worn whenever you're swimming";
...
Outfitter_cShowHelm = "Show Helm";
Outfitter_cShowCloak = "Show Cloak";
Outfitter_cHideHelm = "Hide Helm";
Outfitter_cHideCloak = "Hide Cloak";

Outfitter_cDisableOutfit = "Disable Outfit";
Outfitter_cDisableOutfitInBG = "Disable Outfit when in Battlegrounds";
Outfitter_cDisableOutfitInCombat = "Disable Outfit when in Combat";
Outfitter_cDisableOutfitInAQ40 = "Disable Outfit when in Temple of Ahn'Qiraj";
Outfitter_cDisableOutfitInNaxx = "Disable Outfit when in Naxxramas";
...
Outfitter_cFlightForm = "Flight Form";
Outfitter_cSwiftFlightForm = "Swift Flight Form";
...
Outfitter_cTreeOfLifeForm = "Tree of Life";
...
Outfitter_cDruidFlightForm = "Druid: Flight Form";
Outfitter_cDruidSwiftFlightForm = "Druid: Swift Flight Form";
Outfitter_cDruidTreeOfLifeForm = "Druid: Tree of Life";
Outfitter_cDruidProwl = "Druid: Prowl";
...
Outfitter_cHunterViper = "Hunter: Viper";
...
Outfitter_cAspectOfTheViper = "Aspect of the Viper";
...
Outfitter_cSpecialCategoryDescription = "Special Occasion outfits are automatically worn whenever the occasion warrants it.  They are worn over all other selected outfits.";
...
Outfitter_cDisableScript = "Disable Script";
Outfitter_cEditScriptTitle = "Script for %s outfit";
Outfitter_cEditScriptEllide = "Edit Script...";
Outfitter_cEventsLabel = "Events:";
Outfitter_cScriptLabel = "Script:";
Outfitter_cSetCurrentItems = "Update to current items";
Outfitter_cConfirmSetCurrentMsg = "Are you sure you want to update %s to use the currently equipped items? Note: Only slots currently enabled in the outfit will be updated -- you can turn on additional slots afterwards";
Outfitter_cSetCurrent = "Update";
Outfitter_cTyping = "Typing...";
Outfitter_cScriptErrorFormat = "Error at line %d: %s";
Outfitter_cExtractErrorFormat = "%[string \"Outfit Script\"%]:(%d+):(.*)";
Outfitter_cPresetScript = "Preset script:";
Outfitter_cCustomScript = "Custom";
Outfitter_cSettings = "Settings";
Outfitter_cSource = "Source";
Outfitter_cInsertFormat = "<- %s";

Outfitter_cContainerBagSubType = "Bag";
Outfitter_cContainerEngineeringBagSubType = "Engineering Bag";
Outfitter_cUsedByPrefix = "Used by outfits: ";

Outfitter_cNone = "None";
