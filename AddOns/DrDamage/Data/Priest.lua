...
function DrDamage:PlayerData()
	...
	self.SetBonuses["Absolution Regalia"] = { 31061, 31064, 31065, 31067, 31070 }
	self.SetBonuses["Vestments of Absolution"] = { 31060, 31063, 31066, 31068, 31069 }
	...
	--Auras
	self.PlayerAura["Shadowform"] = { School = "Shadow", Value = 0.15 }
	self.PlayerAura["Flexibility"] = { Value = -0.1, Apps = true, ModType = "CastTime", Spell = BS["Greater Heal"], }
	self.Debuffs["Judgement of the Crusader"] = { School = "Holy", ModType = "RankTable", Ranks = 7, Value = { 20, 30, 50, 80, 110, 140, 190 }, }
	...
	self.spellInfo = { 
		...
		[BS["Devouring Plague"]] = {
					[0] = { School = "Shadow", Instant = true, eDot = true, eDuration = 24, sFactor = 0.5, Cooldown = 180, sTicks = 3, },
		...
		[BS["Shadow Word: Pain"]] = {
					[0] = { School = "Shadow", Instant = true, eDot = true, eDuration = 18, bonusFactor = 1.2 * 0.915, sTicks = 3, },
		...
		[BS["Vampiric Touch"]] = {
					[0] = { School = "Shadow", Instant = true, eDot = true, eDuration = 15, sTicks = 3, },
					[1] = { 450, 450, spellLevel = 50, },
					[2] = { 600, 600, spellLevel = 60, },	
					[3] = { 650, 650, spellLevel = 70, },	
		},		
		[BS["Shadow Word: Death"]] = {
					[0] = { School = "Shadow", Instant = true, canCrit = true, Cooldown = 12, },
					[1] = { 450, 522, spellLevel = 62, },
					[2] = { 572, 664, spellLevel = 70, },				
		},		
		[BS["Mind Blast"]] = {
					[0] = { School = "Shadow", Instant = true, canCrit = true, Cooldown = 8, BaseIncrease = true, LevelIncrease = 5 },
		...
		[BS["Power Word: Shield"]] = {
					[0] = { School = "Holy", Instant = true, Healing = true, bonusFactor = 0.3, Cooldown = 4, NoDPS = true, NoDebuffs = true, NoDoom = true, BaseIncrease = true, LevelIncrease = 5 },
		...
		[BS["Circle of Healing"]] = {
					[0] = { School = { "Holy", "Healing" }, Instant = true, sFactor = 1/3 * 1.5, },
		...
		[BS["Renew"]] = {
					[0] = { School = { "Holy", "Healing" }, Instant = true, eDot = true, eDuration = 15, sTicks = 3, },
		...
		[BS["Prayer of Mending"]] = {
					[0] = { School = { "Holy", "Healing" }, Instant = true, canCrit = true, Cooldown = 10, sHits = 5, sFactor = 5 },
		...
		[BS["Holy Fire"]] = {
					[0] = { School = "Holy", canCrit = true, castTime=3.5, eDuration = 10, sTicks = 2, CastMod = 0.1, hybridFactor = 0.75, BaseIncrease = true,  LevelIncrease = 5 },
		...
		[BS["Holy Nova"]] = {
					[0] = { School = "Holy", Instant = true, canCrit = true, sFactor = 1/3 * 0.8 * 1.5, BaseIncrease = true, LevelIncrease = 7 }, --hFactor = 0.11
					[1] = { 28, 32, 1, 2, 52, 60, 2, 3, spellLevel = 20, },
					[2] = { 50, 58, 2, 3, 86, 98, 3, 3, spellLevel = 28, },
					[3] = { 76, 88, 3, 4, 121, 139, 3, 4, spellLevel = 36, },
					[4] = { 106, 123, 4, 4, 161, 188, 4, 4, spellLevel = 44, },
					[5] = { 140, 163, 6, 5, 235, 272, 4, 4, spellLevel = 52, },
					[6] = { 181, 210, 7, 7, 302, 350, 5, 6, spellLevel = 60, },
					[7] = { 242, 280, 2, 3, 384, 446, 2, 2, spellLevel = 68, },
		},
		[BS["Starshards"]] = {
					[0] = { School = "Arcane", Instant = true, eDuration = 15, eDot = true, sTicks = 3 },
