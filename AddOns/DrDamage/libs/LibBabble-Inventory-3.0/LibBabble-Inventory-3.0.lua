...
lib:SetBaseTranslations {
	...
	["Armor Enchantment"] = true, --New 3.0
	["Weapon Enchantment"] = true, --New 3.0
...
elseif GAME_LOCALE == "frFR" then
	lib:SetCurrentTranslations {
		...
		-- ["Inscription Bag"] = true, -- New 3.0 -- à traduire
		...
		-- Jewelcrafting already defined
		["Materials"] = "Matériaux",
		-- ["Armor Enchantment"] = true, --New 3.0 -- à traduire
		-- ["Weapon Enchantment"] = true, --New 3.0 -- à traduire
		-- Other already defined

		--Miscellaneous
		-- ["Junk"] = true, -- à traduire
...
elseif GAME_LOCALE == "koKR" then
	lib:SetCurrentTranslations {
		...
		["Inscription Bag"] = "주문각인사의 가방", -- New 3.0
		...
		["Armor Enchantment"] = "방어구 마부", --New 3.0
		["Weapon Enchantment"] = "무기 마부", --New 3.0
		-- Other already defined
...
elseif GAME_LOCALE == "ruRU" then
	lib:SetCurrentTranslations {
		...
		["Inscription Bag"] = "Сумка начертателя", -- New 3.0
		...
		["Armor Enchantment"] = "Чары для доспехов", --New 3.0
		["Weapon Enchantment"] = "Чары для оружия	", --New 3.0
		-- Other already defined
		...
		-- Reagent already defined
		["Mount"] = "Верховые животные", -- New 2.4.2
		-- Other already defined
	}
else
