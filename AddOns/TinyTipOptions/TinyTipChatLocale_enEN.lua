...
if TinyTipChatLocale then
	...
	TinyTipChatLocale_Opt_KeyServer						= "Display (*) instead of Server Name"
	...
	TinyTipChatLocale_Desc_KeyServer = "Display (*) next to the unit's name if they are from a different server instead of printing out the server name."
