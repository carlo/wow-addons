...
L:RegisterTranslations("zhTW", function()
	return {
		...
		["Border Alpha"] = "框架透明度",
		["Disable Blizzard Cast Bar"] = "隱藏系統施法條",
		["Snap to Center"] = "移至中間",
		["Icon Position"] = "圖示位置",
		["Text Alignment"] = "文字排列",
		["Text Position"] = "文字位置",
		...
		["Name Text X Offset"] = "名稱文字X軸微調",
		["Name Text Y Offset"] = "名稱文字Y軸微調",
		["Time Text X Offset"] = "時間文字X軸微調",
		["Time Text Y Offset"] = "時間文字Y 微調",
		["Hide Samwise Icon"] = "隱藏代用圖示",
		...
		["Roman Full Text"] = "完整羅馬文字",
			...
			["Buff Color"] = "增益效果的顏色",
			["Debuff Color"] = "負面效果的顏色",
			["Debuffs by Type"] = "依負面效果類型",
			...
			["Hide Blizz Mirror Bars"] = "隱藏暴雪映射施法條",
			["%s Color"] = "%s顏色",
			["Breath"] = "呼吸",
			["Exhaustion"] = "疲勞度",
			["Feign Death"] = "假死",
		...
		["Display the rank of spellcasts alongside their name"] = "顯示法術名稱及等級",
		...
		["Set the color of the %s"] = "設定%s顏色",
		["Set the color of the cast bar when %s"] = "設定當%s時的施法條顏色",
		...
		["Adjust the X position of the name text"] = "調整名稱文字X軸位置",
		["Adjust the Y position of the name text"] = "調整名稱文字Y軸位置",
		["Adjust the X position of the time text"] = "調整時間文字X軸位置",
		["Adjust the Y position of the time text"] = "調整時間文字Y軸位置",
		...
		["Set an exact Y value for this bar's position."] = "設定施法條的Y軸值",
			...
			["Embed mode will decrease it's lag estimates by this amount.  Ideally, set it to the difference between your highest and lowest ping amounts.  (ie, if your ping varies from 200ms to 400ms, set it to 0.2)"] = "嵌入模組會根據這個數值減少延遲估計值。理想上，設定為最高/最低值的差異值是最好的 (例如，你的延遲值介於200ms到400ms，則可設為0.2)",
			["Latency Bar"] = "網路延遲條",
			...
			--GCD
			["%s spell to check for the Global Cooldown"] = "%s法術來確認共同冷卻時間",
			...
			--Buffs
			["Show buffs/debuffs for your %s"] = "顯示你的 %s 增益/負面效果",
			["Show buffs for your %s"] = "顯示你的 %s 增益效果",
			["Show debuffs for your %s"] = "顯示你的 %s 負面效果",
			["Position the bars for your %s"] = "你的 %s 計時條位置",
			...
			["Show icons on buffs and debuffs for your %s"] = "顯示你的 %s 增益/負面效果的圖示",
			...
			["Display the names of buffs/debuffs on their bars"] = "在計時條上顯示增益/負面效果的名稱",
			["Display the time remaining on buffs/debuffs on their bars"] = "在計時條上顯示增益/負面效果所剩餘的時間",
			...
			["Set the color of the bars for debuffs"] = "設定負面計時條的顏色",
			["Set the color of the text for the buff bars"] = "設定增益計時條的文字顏色",
			["Color debuff bars according to their dispel type"] = "根據類型設定負面計時條的顏色",
			["Set the color of the bars for undispellable debuffs"] = "設定無法被消除的負面效果的顏色",
			...
			["Sort the buffs and debuffs by time remaining.  If unchecked, they will be sorted alphabetically."] = "依增益/負面效果剩餘時間排列；若不確定，則依字母排列",
			--Mirror
			["Position the mirror bars"] = "mirror bars 位置",
			...
			["Set the color of the bars for %s"] = "設定 %s 施法條的顏色",
			["Show mirror bars such as breath and feign death"] = "顯示呼吸及假死",
			["Show bars for static popup items such as rez and summon timers"] = "顯示物品召喚計時",
			...
			--Timer
			["Make a new timer using the above settings.  NOTE: it may be easier for you to simply use the command line to make timers, /qt"] = "使用以上設定新增一個計時器。注意：使用/qt指令來新增計時間也許較為便利",
		...
		["Rank %s"] = "等級 %s",
			...
			["<Spell Name>"] = "<法術名稱>",
			["Invalid Spell"] = "無效的法術",
			["Spell_Warning"] = "|cffff3333注意：你尚未選用法術設定給共用卻冷模組，請在設定視窗中輸入法術名稱(點擊共同冷卻設定)。請使用無法被中斷且只有共同冷卻沒由其他冷卻時間的法術，例如尋找草藥。",
			--Buffs
			["%dm"] = "%d分",
			--Mirror
			["Logout"] = "登出",
			...
			["Game Start"] = "戰鬥開始",
			["1 minute"] = "1分",
			["One minute until"] = "1分後",
			["30 seconds"] = "30秒",
			["Thirty seconds until"] = "30秒後",
			["15 seconds"] = "15秒",
			["Fifteen seconds until"] = "15秒後",
			--Timer
			['Usage: /quartztimer timername 60 or /quartztimer 60 timername'] = "使用: /quartztimer timername 60 或 /quartztimer 60 timername",
